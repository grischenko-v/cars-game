...
const terrainProfiles: Record<TerrainReliefKind, TerrainProfile> = {
  ...
  mountains: {
    ...
    heightAmplitude: 12.5,
    primaryFrequency: 0.0046,
    secondaryFrequency: 0.0072,
    detailFrequency: 0.021,
    ridgeAmplitude: 14.5,
    ridgeFrequency: 0.0048,
    massifAmplitude: 34,
    massifFrequency: 0.0029,
    massifSharpness: 2.9,
    valleyWallAmplitude: 38,
    valleyWallDistance: 120,
    valleyWallRamp: 300,
    roadsideCliffAmplitude: 18,
    roadsideCliffFrequency: 0.0038,
    roadsideCliffThreshold: 0.36,
  },
}
